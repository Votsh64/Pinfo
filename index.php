...
<body>
    <div class="container">
        ...
        <footer class="footer">
            <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/fr/">Creative Commons BY-NC-SA</a> 2013 - mGeek <a href="http://twitter.com/mGeek_"><i class='icon-twitter'></i></a>
        </footer>
        <br>
